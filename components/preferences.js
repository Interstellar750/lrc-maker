...
export const Preferences = () => {
    ...
    const onUserColorInputBlur = useCallback((ev) => onUserInput(ev.target), [onUserInput]);
    ...
    const updateTime = useMemo(() => {
        const date = new Date("2022-10-22T10:52:25+08:00");
        const options = {
            year: "numeric",
            month: "short",
            day: "numeric",
        ...
        React.createElement("ul", null,
            React.createElement("li", null,
                React.createElement("section", { className: "list-item" },
                    ...
                    React.createElement("span", { className: "select-all" }, "5.6.6"))),
            React.createElement("li", null,
                React.createElement("section", { className: "list-item" },
                    React.createElement("span", null, lang.preferences.commitHash),
                    React.createElement("span", { className: "select-all" }, "26783c9"))),
            React.createElement("li", null,
                React.createElement("section", { className: "list-item" },
